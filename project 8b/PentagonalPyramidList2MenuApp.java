...
/** . 
 * Program that gives for Pyramid objects
 * Project 7
 ...
 */
   public static void main(String[] args) throws FileNotFoundException
   {
      ...
      PentagonalPyramid[] pList = new PentagonalPyramid[20];
      PentagonalPyramidList2 myPList = new PentagonalPyramidList2(pListName,
         pList, 0);
      ...
      do {
         ...
         switch(codeChar) {
            ...
            case 'D': // Delete Pentagonal Pyramid
               ...
               PentagonalPyramid deletingPp = myPList.findPentagonalPyramid(
                  label); 
